...
Queremos saber si la negativa es más frecuente en hombres que mujeres.
...
* La proporción total de individuos **en contra** es p=frac(490+400)500+500=89
...
**Interpretación**: El valor p de la prueba es 2,36310^{-19}, que es menor que el nivel de significancia alfa = 0,05. Podemos concluir que la proporción de fumadores es significativamente diferente en los dos grupos con un valor de p = 2.36310^{-19}.
...
**Interpretación**: El valor p de la prueba es 8,80310^{-7}, que es menor que el nivel de significación alfa = 0.05. Podemos concluir que los colores no tienen una distribución común significativa con un valor p = 8.80310^{-7}.
...
```{r}
evaluacion <- c(81, 50, 27)
res <- evaluacion(tulip, p = c(1/2, 1/3, 1/6))
res
```
