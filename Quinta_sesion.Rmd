...
En el conjunto de datos pintores, la distribución de frecuencias de la variable Escuela es un resumen del número de pintores en cada escuela.
...
Aplicamos la función de tabla para calcular la distribución de frecuencias de la variable School.
```{r}
school = pintores$School # las escuelas de pintores
...
En el conjunto de datos de pintores, la distribución de frecuencia relativa de la variable Escuela es un resumen de la proporción de pintores en cada escuela.
...
- Problema
Encuentre la duración media de la erupción en el conjunto de datos fiel.

- Solución
Aplicamos la función media para calcular el valor medio de las erupciones.
```{r}
...
- Problema
Encuentre la mediana de la duración de la erupción en el conjunto de datos fieles.

- Solución
Aplicamos la función mediana para calcular el valor mediano de las erupciones.
```{r}
median(duration)      
```
...
- Solución
Aplicamos la función cuantil para calcular los cuartiles de las erupciones.
```{r}
quantile(duration)  
```
...
- Problema
Encuentre los percentiles 32, 57 y 98 de las duraciones de las erupciones en el conjunto de datos fieles.

- Solución
Aplicamos la función cuantil para calcular los percentiles de las erupciones con las proporciones porcentuales deseadas.
```{r}
